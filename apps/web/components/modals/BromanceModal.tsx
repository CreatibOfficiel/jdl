      ...
      {open && (
        ...
        >
          ...
          >
                ...
                return (
                  <li key={p.id}>
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-xl border-2 border-zinc-200 bg-white px-3 py-3 text-left transition hover:border-pink-400 hover:bg-pink-50 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-white"
                    >
                      <span
            ...
            {others.length === 0 && (
              <p className="text-center text-sm text-zinc-500">Pas d'autres joueurs disponibles.</p>
            )}
          </motion.div>
        </motion.div>
      )}

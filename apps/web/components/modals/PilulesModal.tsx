        ...
        >
          ...
          >
            <header className="mb-3 text-center">
              ...
              {isMyTurn ? (
                <p className="mt-1 text-sm text-zinc-600">Choisis : rouge ou bleue ?</p>
              ) : (
                <p className="mt-1 text-sm text-zinc-600">{activePlayerName} hésite…</p>
              )}
            </header>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="rounded-2xl border-2 border-blue-300 bg-gradient-to-br from-blue-500 to-blue-700 p-5 text-center text-white shadow-md transition hover:from-blue-600 hover:to-blue-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <div className="text-5xl">🔵</div>
